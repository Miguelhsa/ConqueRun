// Polyfill for crypto.subtle.digest (used by Firebase Auth for Apple Sign-In nonce verification).
// Hermes does not expose crypto as a global — this sets global.crypto before Firebase Auth loads.
...
if (!global.crypto || !global.crypto.subtle) {
  ...
  global.crypto.subtle = {
    digest: (_algorithm, data) => Promise.resolve(_sha256Bytes(data)),
  };
}
